...
import com.robottitto.tarefapmdm03.ui.order.adapter.ModifyOrderStatusAdapter;
...
public class PendingOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            orders = orderModelService.findOrdersByStatus(Status.PENDING.getStatus());
            // Adapter
            mAdapter = new ModifyOrderStatusAdapter(orders);
